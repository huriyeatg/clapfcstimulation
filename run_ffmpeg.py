# Easy use of ffmpeg file - python-utils by Kyle McDonald
#https://github.com/kylemcdonald/python-utils/blob/master/ffmpeg.py
...
class VideoWriter:
    def __init__(self, fn, vcodec='libx264', fps=30, input_args=None, output_args=None):#in_pix_fmt='rgb24', out_pix_fmt='yuv420p'
        self.fn = fn
        self.process = None
